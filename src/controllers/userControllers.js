...
const userCadastro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newUser = yield Models.userCadastro(name, email, password);
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Models.userLogin(email, password);
    res.status(200).json({
        token: result.token,
