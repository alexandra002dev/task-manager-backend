...
const getAllTasks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let tasks = yield tasksControllers.getTasks(req.userId);
    res.json(tasks);
});
...
const createTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newTask = yield tasksControllers.createTask(title, req.userId);
    res.json(newTask);
});
...
const deleteTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield tasksControllers.deleteTask(id, req.userId);
...
const updateTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield tasksControllers.updateTask(id, title, completed, req.userId);
